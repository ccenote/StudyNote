...
进程是操作系统分配资源的最小单位，是一个正在执行的程序；而线程是进程中一个执行流，是CPU调度和分派的最小单位。
...
线程池一般用于执行多个不关联的耗时任务，使用线程池的话可以让多个不相关的任务同时执行。
...
1. 什么是Lock接口？与synchronized关键字有什么区别？
2. 什么是CAS（Compare and Swap）操作？如何使用CAS实现原子操作？
3. 什么是原子操作？为什么要使用原子操作？
4. 什么是线程的上下文切换？如何减少上下文切换的次数？
5. 什么是守护线程？如何创建和使用守护线程？
6. 什么是线程的优先级？如何设置和使用线程的优先级？
